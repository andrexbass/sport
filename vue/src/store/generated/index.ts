...
import AndrexbassSportAndrexbassSportSport from './andrexbass/sport/andrexbass.sport.sport'
...
export default { 
  AndrexbassSportAndrexbassSportSport: load(AndrexbassSportAndrexbassSportSport, 'andrexbass.sport.sport'),
